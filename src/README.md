...
go generate ./cmd/le-responder && \
    ...
    bosh ssh -d cf tls-credhub/0 'sudo bash -c "rm /var/vcap/packages/le-responder/bin/le-responder && cp /tmp/le-responder /var/vcap/packages/nginx-tls-config-go-tools/bin && /var/vcap/bosh/bin/monit restart le-responder /var/vcap/packages/le-responder/bin/"'
```
